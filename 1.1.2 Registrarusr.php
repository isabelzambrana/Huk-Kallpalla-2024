...
//isset permite ver q no son nulos y empty para que no esten vacios!!
        ...
        $consulta2="INSERT INTO info_usuario(`ci`, `nombres`, `ap_p`, `ap_m`, `telefono`, `direccion`, `monedas`, `fecha_n`, `rol`, `usuario_idusuario`) VALUES('$ci','$nombres','$ap_p','$ap_m','$telefono','$direccion',0,'$fecha_n',1,0);"; //el 0 significa que ya esta autoincrementado
